...
<?php if ( have_comments() ) : ?>
	<h3 id="comments">Este articulo tiene: <?php comments_number( '0 comentarios', 'un comentario', '% comentarios' ); ?>.”</h3>

	<ol>
		<?php wp_list_comments(); //this is the important part that ensures we call our custom comment layout defined above
                ?>
	</ol>
	<div></div>
	<div>
...
<h3><?php comment_form_title( 'Escribe un comentario', 'Escribe un comentario a %s' ); ?></h3>
